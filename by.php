<?php include_once('header.php');?>
  ...
  <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="keluar.php">Form Barang Hybrid</a></li>
      <!--   <li class="active"></li> -->
      </ol>
  </section>
     ...
     <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
 <!-- form start -->
            <form role="form" method="post"  action="proses_simpan_by.php" enctype="multipart/form-data">
              <div class="box-body">
              ...
              <div class="form-group">
                ...
                <select class="form-control select2" name="kode_barang" style="width: 100%;" id="kode_barang"  required="required" onchange="isi_otomatis()">
                   ...
                   <?php
                       ...
                       //Perintah sql untuk menampilkan semua data pada tabel jurusan
                        $sql="select * from mbarang where kode_barang like 'H%'";
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                      ...
                      $a = mysqli_query($koneksi, "SELECT a.nama_barang, b.tgl_trxin, b.jumlah, a.satuan, c.nama_lokasi
                        ...
                        where a.kode_barang=b.kode_barang and b.id_lokasi = c.id_lokasi and a.kode_barang like 'H%'
