<?php
  ...
  // untuk pengkodean
  $no = mysqli_query($koneksi, "SELECT  max(kode_barang) as kode_barang FROM mbarang WHERE id_kategori = '".$kode."'");
  // untuk nama kategoti
            ...
            <button type="button" id="btn-reset-form">Reset Form</button><br><br> -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text"class="form-control" id="exampleInputEmail1" name="nama_kategori" value="<?php echo $nm;?>" readonly="readonly">
