            ...
            <form role="form" method="post"  action="proses_ubahBhp.php?bhp_id=<?php echo $bhp_id; ?>" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="berat" required="required" onkeyup="this.value = this.value.toUpperCase()" class="form-control" id="exampleInputEmail1" value="<?php echo $data['berat']; ?>" >
                </div>
                  ...
                  <select class="form-control select2" name="id_merk" style="width: 100%;" required="required">
                   ...
                   <?php
                       ...
                       //Perintah sql untuk menampilkan semua data pada tabel jurusan
                        ...
                        $no=0;
                        while ($row = mysqli_fetch_array($hasil)) {
                        if ($data['id_merk']==$row['id_merk']) {
                               $select="selected";
                              }else{
                               $select="";
                              }
                              echo "<option value=".$row['id_merk']." $select>".$row['nama_merk']."</option>";
                      }
                      ?>
                </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="spek" required="required" onkeyup="this.value = this.value.toUpperCase()" class="form-control" id="exampleInputEmail1" value="<?php echo $data['spek']; ?>" >
                </div>
