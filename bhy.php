<?php include_once('header.php');?>
  ...
  <div class="content-wrapper" style="height: 4200px; min-height: 293px;">
    ...
    <section class="content-header">
      <h1>
        Table
        <small>Barang Hybrid</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Table Barang Hybrid</a></li>
      <!--   <li class="active"></li> -->
      </ol>
    </section>  
       ...
       <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action= "proses_simpan_bhy.php" enctype="multipart/form-data">
              <div class="box-body">
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <?php
                       ...
                       //Perintah sql untuk menampilkan semua data pada tabel jurusan
                        $sql="select case 
                        when count(kode_barang) < 10 then CONCAT('H00',count(kode_barang)+1) 
                        when count(kode_barang) < 100 then CONCAT('H0',count(kode_barang)+1) 
                        ELSE
                        CONCAT('H',count(kode_barang)+1) 
                        end as maxkode
                        from mbarang 
                        where kode_barang like 'H%';";
              ...
              <div class="box-footer">
                ...
                <input type="button" onclick="location.href='by.php';" class="btn btn-primary" value="Barang Masuk" />
              </div>
            </form>
          </div>
          </div>
